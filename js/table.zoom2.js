...
content = '<div class="zoom-container" style="width: 1001px; height: 750px; background: url(images/video.png) no-repeat; background-size: 100% 100%">';
...
for (i=1; i<=15; i++) {
	...
	for (j=1; j<=20; j++) {
		...
		content += '<div data-col="'+col+'" class="tile left '+health+' '+last+'">';			
			content += '<a href="#" title="'+tooltip+'" class="zoom-2" ';
...
content += '</div>';
$('.content-level-2 .devices').before(content);